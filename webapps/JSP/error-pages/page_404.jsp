...
<body class="nav-md" style="overflow: hidden; margin: 0;background-color: #EDEDED;">
	<div class="container body">
		<div id="main" class="main_container">
			<!-- page content -->
			<div class="row">
				<div class="col-md-12 xol-sm-12 col-xs-12" style="background-color: #2A3F54;">
			...
			<div class="row">
				<div class="col-md-12 xol-sm-12 col-xs-12" style="background-color: #EDEDED;">
					<div class="col-middle">
						<div class="text-center text-center">
							<img
